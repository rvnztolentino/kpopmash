    ...
    <footer className="bg-blue-900 text-white mt-auto">
      ...
      <div className="container mx-auto">
        <div className="flex w-full text-center">
          <button
            ...
            className={`flex-1 py-4 font-bold text-lg tracking-wider transition-colors duration-200 ${
      ...
      <div className="bg-gray-900 py-8 px-4 text-center">
        <div className="max-w-2xl mx-auto space-y-4">
          <h3 className="text-xl font-semibold">About AnimeMash</h3>
          <p className="text-gray-400 text-sm leading-relaxed">
            Vote for the best anime characters! We use the Elo rating system to calculate rankings based on your pairwise choices. 
          ...
          <p className="text-xs text-gray-600 pt-6">
            &copy; {new Date().getFullYear()} AnimeMash. Images belong to their respective owners.
          </p>
        </div>
      </div>
    </footer>
