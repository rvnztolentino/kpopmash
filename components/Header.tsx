        ...
        <div className="flex items-center space-x-4">
          {user ? (
            <div className="flex items-center space-x-3 group relative cursor-pointer">
               ...
               {/* Dropdown */}
               <div className="absolute top-full right-0 mt-2 w-48 bg-white text-gray-800 rounded shadow-lg overflow-hidden hidden group-hover:block border border-gray-200">
                  <button 
                    onClick={onLogout}
